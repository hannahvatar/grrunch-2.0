...
const styles = StyleSheet.create({
  ...
  categoryLabel: { fontSize: 15, fontWeight: '800', fontFamily: 'OpenSans_800ExtraBold' },
  categorySpacer: { marginTop: 16 },
  label: { fontSize: 12, fontWeight: '700', fontFamily: 'OpenSans_700Bold', color: '#888', letterSpacing: 0.5, marginTop: 12 },
